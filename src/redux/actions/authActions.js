...
export const loginUserEmailPassword = ({ email, password }) => {
	console.log('loginUserEmailPassword');
	return (dispatch) => {
...
export const loginUserFacebook = (facebookToken, userProfile) => {
	console.log('loginUserFacebook', userProfile);
...
export const loginUserGoogle = (googleToken, userProfile) => {
	console.log('loginUserGoogle', userProfile);
...
export const createUserEmailPassword = ({ name, surname, email, password }, userProfile) => {
	console.log('createUserEmailPassword', userProfile);
	return (dispatch) => {
		...
		firebase.database().ref(`/users/${currentUser.uid}/userId`)
			.on('value', (snapshot) => {
				...
				if((snapshotValue !== null) && (snapshotValue !== undefined)){
					...
					// displayAlertError('Impossible de récupérer les données de l\'utilisateur. Essayez de vous reconnecter');
					dispatch({ 
...
const firebaseErrorManager = (dispatch, error) => {
	...
	console.log('firebaseErrorManager: ', error);
